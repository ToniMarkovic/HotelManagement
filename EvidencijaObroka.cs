...
namespace ProjektUpi
{
    public partial class EvidencijaObroka : Form
    {
        ...
        SqlConnection VezaNaBazu = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Faks\3.godina\1.dio\UPI_Done\ToniMarkovicc\ProjektUpi\Baza\Database1.mdf;Integrated Security=True;Connect Timeout=30");
